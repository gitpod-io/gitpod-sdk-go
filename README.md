...
```sh
go get -u 'github.com/gitpod-io/flex-sdk-go@v0.0.1-alpha.0'
```
...
`*gitpod.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `gitpod.FileParam(reader io.Reader, filename string, contentType string)`
