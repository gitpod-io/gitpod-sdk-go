...
func TestEnvironmentAutomationTaskDeleteWithOptionalParams(t *testing.T) {
	...
	_, err := client.EnvironmentAutomations.Tasks.Delete(context.TODO(), gitpod.EnvironmentAutomationTaskDeleteParams{
...
func TestEnvironmentAutomationTaskStartWithOptionalParams(t *testing.T) {
	...
	_, err := client.EnvironmentAutomations.Tasks.Start(context.TODO(), gitpod.EnvironmentAutomationTaskStartParams{
