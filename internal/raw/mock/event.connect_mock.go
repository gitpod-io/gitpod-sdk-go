...
//
//	mockgen -source=v1/v1connect/event.connect.go -destination=internal/raw/mock/event.connect_mock.go -package=mock
//
...
func (m *MockEventServiceClient) GetAuditLog(arg0 context.Context, arg1 *connect.Request[v1.GetAuditLogRequest]) (*connect.Response[v1.GetAuditLogResponse], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAuditLog", arg0, arg1)
	ret0, _ := ret[0].(*connect.Response[v1.GetAuditLogResponse])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAuditLog indicates an expected call of GetAuditLog.
func (mr *MockEventServiceClientMockRecorder) GetAuditLog(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAuditLog", reflect.TypeOf((*MockEventServiceClient)(nil).GetAuditLog), arg0, arg1)
}
...
// GetAuditLog mocks base method.
func (m *MockEventServiceHandler) GetAuditLog(arg0 context.Context, arg1 *connect.Request[v1.GetAuditLogRequest]) (*connect.Response[v1.GetAuditLogResponse], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAuditLog", arg0, arg1)
	ret0, _ := ret[0].(*connect.Response[v1.GetAuditLogResponse])
	ret1, _ := ret[1].(error)
...
// GetAuditLog indicates an expected call of GetAuditLog.
func (mr *MockEventServiceHandlerMockRecorder) GetAuditLog(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAuditLog", reflect.TypeOf((*MockEventServiceHandler)(nil).GetAuditLog), arg0, arg1)
}
