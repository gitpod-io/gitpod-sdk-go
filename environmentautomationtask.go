...
type EnvironmentAutomationTaskNewListResponse struct {
	Pagination EnvironmentAutomationTaskNewListResponsePagination `json:"pagination"`
	Tasks      []EnvironmentAutomationTaskNewListResponseTask     `json:"tasks"`
	JSON       environmentAutomationTaskNewListResponseJSON       `json:"-"`
}

// environmentAutomationTaskNewListResponseJSON contains the JSON metadata for the
// struct [EnvironmentAutomationTaskNewListResponse]
type environmentAutomationTaskNewListResponseJSON struct {
	Pagination  apijson.Field
	Tasks       apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
...
func (r *EnvironmentAutomationTaskNewListResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r environmentAutomationTaskNewListResponseJSON) RawJSON() string {
	return r.raw
}

type EnvironmentAutomationTaskNewListResponsePagination struct {
	// Token passed for retreiving the next set of results. Empty if there are no more
	// results
	NextToken string                                                 `json:"nextToken"`
	JSON      environmentAutomationTaskNewListResponsePaginationJSON `json:"-"`
}

// environmentAutomationTaskNewListResponsePaginationJSON contains the JSON
// metadata for the struct [EnvironmentAutomationTaskNewListResponsePagination]
type environmentAutomationTaskNewListResponsePaginationJSON struct {
	NextToken   apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
}

func (r *EnvironmentAutomationTaskNewListResponsePagination) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r environmentAutomationTaskNewListResponsePaginationJSON) RawJSON() string {
	return r.raw
}

type EnvironmentAutomationTaskNewListResponseTask struct {
	ID string `json:"id" format:"uuid"`
	// dependencies specifies the IDs of the automations this task depends on.
	DependsOn     []string                                              `json:"dependsOn" format:"uuid"`
	EnvironmentID string                                                `json:"environmentId" format:"uuid"`
	Metadata      EnvironmentAutomationTaskNewListResponseTasksMetadata `json:"metadata"`
	Spec          EnvironmentAutomationTaskNewListResponseTasksSpec     `json:"spec"`
	JSON          environmentAutomationTaskNewListResponseTaskJSON      `json:"-"`
}

// environmentAutomationTaskNewListResponseTaskJSON contains the JSON metadata for
// the struct [EnvironmentAutomationTaskNewListResponseTask]
type environmentAutomationTaskNewListResponseTaskJSON struct {
	ID            apijson.Field
	DependsOn     apijson.Field
	EnvironmentID apijson.Field
	Metadata      apijson.Field
...
func (r *EnvironmentAutomationTaskNewListResponseTask) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r environmentAutomationTaskNewListResponseTaskJSON) RawJSON() string {
	return r.raw
}

type EnvironmentAutomationTaskNewListResponseTasksMetadata struct {
	// A Timestamp represents a point in time independent of any time zone or local
	// calendar, encoded as a count of seconds and fractions of seconds at nanosecond
	// resolution. The count is relative to an epoch at UTC midnight on January 1,
	// 1970, in the proleptic Gregorian calendar which extends the Gregorian calendar
	...
	CreatedAt time.Time `json:"createdAt" format:"date-time"`
	// creator describes the principal who created the task.
	Creator EnvironmentAutomationTaskNewListResponseTasksMetadataCreator `json:"creator"`
	// description is a user-facing description for the task. It can be used to provide
	// context and documentation for the task.
	Description string `json:"description"`
	// name is a user-facing name for the task. Unlike the reference, this field is not
...
// metadata for the struct [EnvironmentAutomationTaskNewListResponseTasksMetadata]
type environmentAutomationTaskNewListResponseTasksMetadataJSON struct {
	CreatedAt   apijson.Field
	Creator     apijson.Field
	Description apijson.Field
	Name        apijson.Field
...
func (r *EnvironmentAutomationTaskNewListResponseTasksMetadata) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r environmentAutomationTaskNewListResponseTasksMetadataJSON) RawJSON() string {
	return r.raw
}

// creator describes the principal who created the task.
type EnvironmentAutomationTaskNewListResponseTasksMetadataCreator struct {
	// id is the UUID of the subject
	ID string `json:"id"`
	// Principal is the principal of the subject
	Principal EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipal `json:"principal"`
	JSON      environmentAutomationTaskNewListResponseTasksMetadataCreatorJSON      `json:"-"`
}

// environmentAutomationTaskNewListResponseTasksMetadataCreatorJSON contains the
// JSON metadata for the struct
// [EnvironmentAutomationTaskNewListResponseTasksMetadataCreator]
type environmentAutomationTaskNewListResponseTasksMetadataCreatorJSON struct {
	ID          apijson.Field
	Principal   apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
...
func (r *EnvironmentAutomationTaskNewListResponseTasksMetadataCreator) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r environmentAutomationTaskNewListResponseTasksMetadataCreatorJSON) RawJSON() string {
	return r.raw
}

// Principal is the principal of the subject
type EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipal string

const (
	EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipalPrincipalUnspecified    EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipal = "PRINCIPAL_UNSPECIFIED"
	EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipalPrincipalAccount        EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipal = "PRINCIPAL_ACCOUNT"
	EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipalPrincipalUser           EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipal = "PRINCIPAL_USER"
	EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipalPrincipalRunner         EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipal = "PRINCIPAL_RUNNER"
	EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipalPrincipalEnvironment    EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipal = "PRINCIPAL_ENVIRONMENT"
	EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipalPrincipalServiceAccount EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipal = "PRINCIPAL_SERVICE_ACCOUNT"
)

func (r EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipal) IsKnown() bool {
	switch r {
	case EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipalPrincipalUnspecified, EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipalPrincipalAccount, EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipalPrincipalUser, EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipalPrincipalRunner, EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipalPrincipalEnvironment, EnvironmentAutomationTaskNewListResponseTasksMetadataCreatorPrincipalPrincipalServiceAccount:
		return true
	}
	return false
}
...
type EnvironmentAutomationTaskNewListResponseTasksSpec struct {
	// command contains the command the task should execute
	Command string                                                `json:"command"`
	JSON    environmentAutomationTaskNewListResponseTasksSpecJSON `json:"-"`
}

// environmentAutomationTaskNewListResponseTasksSpecJSON contains the JSON metadata
// for the struct [EnvironmentAutomationTaskNewListResponseTasksSpec]
type environmentAutomationTaskNewListResponseTasksSpecJSON struct {
	Command     apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
}

func (r *EnvironmentAutomationTaskNewListResponseTasksSpec) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r environmentAutomationTaskNewListResponseTasksSpecJSON) RawJSON() string {
	return r.raw
}
...
type EnvironmentAutomationTaskStartResponseTaskExecutionStatus struct {
	...
	// status before b.
	StatusVersion EnvironmentAutomationTaskStartResponseTaskExecutionStatusStatusVersionUnion `json:"statusVersion"`
...
// Satisfied by [EnvironmentAutomationTaskUpdateParamsSpecUnknown],
// [EnvironmentAutomationTaskUpdateParamsSpecUnknown].
...
type EnvironmentAutomationTaskNewListParams struct {
	// Define the version of the Connect protocol
	ConnectProtocolVersion param.Field[EnvironmentAutomationTaskNewListParamsConnectProtocolVersion] `header:"Connect-Protocol-Version,required"`
	// filter contains the filter options for listing tasks
	Filter param.Field[EnvironmentAutomationTaskNewListParamsFilter] `json:"filter"`
	// pagination contains the pagination options for listing tasks
	Pagination param.Field[EnvironmentAutomationTaskNewListParamsPagination] `json:"pagination"`
	// Define the timeout, in ms
	ConnectTimeoutMs param.Field[float64] `header:"Connect-Timeout-Ms"`
}

func (r EnvironmentAutomationTaskNewListParams) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// Define the version of the Connect protocol
type EnvironmentAutomationTaskNewListParamsConnectProtocolVersion float64

const (
	EnvironmentAutomationTaskNewListParamsConnectProtocolVersion1 EnvironmentAutomationTaskNewListParamsConnectProtocolVersion = 1
)

func (r EnvironmentAutomationTaskNewListParamsConnectProtocolVersion) IsKnown() bool {
	switch r {
	case EnvironmentAutomationTaskNewListParamsConnectProtocolVersion1:
		return true
	}
	return false
}
...
// filter contains the filter options for listing tasks
type EnvironmentAutomationTaskNewListParamsFilter struct {
...
func (r EnvironmentAutomationTaskNewListParamsFilter) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// pagination contains the pagination options for listing tasks
type EnvironmentAutomationTaskNewListParamsPagination struct {
...
func (r EnvironmentAutomationTaskNewListParamsPagination) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}
